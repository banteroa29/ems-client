						...
						<div class="col-md-12">
							<div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <Dialog v-model:visible="newDialog" :style="{width: '450px'}" header="New Employee Type" :modal="true" class="p-fluid">
                                        <div class="p-field">
...
export default {
    data() {
        return {
           ...
           loading : true,
           breadcrumb : {
                home : { icon: 'pi pi-home',to : '/',label : 'Employee Types' },
                items : [
                    {label : 'Settings'},
                    {label : 'Employee Types List'},
                ]
            },
    ...
    mounted() {
        this.ApiService.getEmployeeTypes().then(res => {
            ...
            res.data.forEach(element => {
                this.employeeTypes.push(element.data)
            });
