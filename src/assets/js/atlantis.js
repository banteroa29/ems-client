...
$(document).ready(function(){
	...
	var nav_open = 0;
	var quick_sidebar_open = 0;
	var toggle_topbar = false;
	var topbar_open = 0;
	var minimize_sidebar = false;
	var mini_sidebar = 0;
	var toggle_page_sidebar = false;
	var page_sidebar_open = 0;
	// var toggle_quick_sidebar = false;
	var toggle_overlay_sidebar = false;
	var overlay_sidebar_open = 0;
	...
	if(!quick_sidebar_open) {
		...
		$('.quick-sidebar-toggler').on('click', function(){
			if (nav_open == 1){
				...
				$('.quick-sidebar-toggler').addClass('toggled');
